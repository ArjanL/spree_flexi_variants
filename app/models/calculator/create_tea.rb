class Calculator::CreateTea < Calculator
  ...
  preference :rozenbottel, :decimal
 ...
 # preference :min_amount, :integer, :default=>0
  ...
  def create_options
    ...
    CustomizableProductOption.create(:name=>"rozenbottel", :presentation=>"Rozenbottel"),
    ...
    def compute(product_customization)
    	...
    	#return 0 unless valid_configuration? product_customization
			...
			rozenbottel = get_option(product_customization, "rozenbottel")
